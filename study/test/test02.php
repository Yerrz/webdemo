                ...
                function showTopic($arr, $tn, $keys)
                {
                    ...
                    foreach ($arr as $key => $val) {
                        if ($val[0]) {
                            ...
                            if($t != 't2') $topic_index++;
                            echo
                            '<li style="background-color:'.$classif_item_color.';">
                            ...
                            foreach ($val[1] as $key2 => $val2) {
                                ...
                                if ($flag) {
                                    $count++;
                                    if ($count > $max) {
                                        echo '<div style="display:none;" class="classif_item" id="classif_item_' . $key . $key2 . '" onclick="window.location.href=\'?do=list&' . $t2 . '=' . $key . 'b' . $key2 . '\'"><label for="classif_item_' . $key . $key2 . '">' . $value . '</label></div>';
                                        // echo '<div class="classif_item" id="classif_item_more" onclick=""><label for="classif_item_more">...</label></div>';
                                    } else {
                                ...
                                // if($t == 't1'){
                                //     echo '<div class="classif_item" id="classif_item_' . $key2 . '" onclick="window.location.href=\'?do=list&' . $t2 . '=' . $key . 'b' . $key2 . '\'"><label for="classif_item_' . $key2 . '">' . $val2[0] . '</label></div>';
                                // }
                                // elseif($t == 't2'){
                                //     echo '<div class="classif_item" id="classif_item_' . $key2 . '" onclick="window.location.href=\'?do=list&' . $t2 . '=' . $key . 'b' . $key2 . '\'"><label for="classif_item_' . $key2 . '">' . $val2 . '</label></div>';
                                // } 
                            }
                            if ($flag)    echo '<div class="classif_item" id="classif_item_more" onclick="showMore(\'' . $key . $key2 . '\')"><label for="classif_item_more">...</label></div>';
                            echo '</div></li>';
                        }
                    }
                }
